...
### Hội nghị khoa học tiêu biểu
  -  [Edge AI Research Symposium (tiền thân là tinyML Symposium)](https://arxiv.org/search/?query=tinyML+Research+Symposium&searchtype=all&source=header): Diễn đàn lớn nhất tập trung vào việc thu nhỏ các mô hình học máy và mô hình ngôn ngữ xuống thiết bị nhúng, thiết bị biên tiêu thụ điện năng thấp.
...
### Top Journals
  ...
  -  [IEEE Transactions on Software Engineering, Q1](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp): A leading archival journal covering methods and design principles for large-scale systems.
  -  [Formal Methods in System Design, Q3](https://www.springer.com/journal/10703): Focuses on mathematical and rigorous techniques for designing and verifying hardware and software systems.
